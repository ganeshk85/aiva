...
.factory('inspector', ['$rootScope', 'css', 'aivaVariant', function($rootScope, css, aivaVariant) {
	...
	var inspector = {
		...
		applySliderValue: function(name, value, append) {
			...
			if ($rootScope.selecting) {
				...
				css.add(false, name, prop, false, selectedVariantClass, true);
			}
		},
