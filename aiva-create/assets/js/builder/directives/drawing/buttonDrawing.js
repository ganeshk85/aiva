(function() {
    ...
    angular.module('builder').directive('aivaButtonDrawing', aivaButtonDrawing);
    
    aivaButtonDrawing.$inject = [];
    
    function aivaButtonDrawing() {
        var directive = {
            restrict: 'A',
            link: buttonDrawingLink,
            controller: ButtonDrawingController,
            controllerAs: 'vm'
        };
        ...
        function buttonDrawingLink($scope, el, attrs, ctrl) {
        ...
        ButtonDrawingController.$inject = 
        ['$scope', '$rootScope', 'elementDrawing', 'aivaElementConfig', 'elementScaling', 'cssUpdates', 'ctaBase', 'undoRedo', 'aivaVariant', 'draggable'];
        
        function ButtonDrawingController($scope, $rootScope, elementDrawing, aivaElementConfig, elementScaling, cssUpdates, ctaBase, undoRedo, aivaVariant, draggable) {
            var vm = this;
            vm.coordStart = {};
            vm.pageCoordStart = {};
            vm.coordLatest = {};
