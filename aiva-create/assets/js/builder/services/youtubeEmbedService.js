angular.module('builder').service('youtubeEmbedUtils', ['$window', '$rootScope', function ($window, $rootScope) {
    var Service = {};
    ...
    .directive('youtubeVideo', ['$window', 'youtubeEmbedUtils', function ($window, youtubeEmbedUtils) {
        ...
        return {
            ...
            link: function (scope, element, attrs) {
                ...
                // Attach to element
                scope.playerHeight = scope.playerHeight || '100%';
                scope.playerWidth = scope.playerWidth || '100%';
                ...
                function createPlayer() {
                    console.log(playerId, $('#previewElement'), $('#previewElement').length);
                    var playerVars = angular.copy(scope.playerVars);
                    playerVars.start = playerVars.start || scope.urlStartTime;
                    playerVars.autoplay = scope.autoplay;
