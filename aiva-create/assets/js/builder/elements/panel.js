...
.directive('blToggleElDescriptions', function() {
    return {
          ...
          console.error( "to be removed: blToggleElDescriptions");
...
.directive('blElPanelFilterable', function() {
    return {
      	...
      	link: function($scope, el) {
            ...
            console.warn ( "blElPanelFilterable : on 'framework' ", name );
...
.directive('blElPanelSearchable', function() {
    return {
          ...
          console.error( "to be removed: blElPanelSearchable");
...
.directive('blElementPreview', ['elements', function(elements) {
    return {
        ...
        link: function($scope, el) {
            ...
            console.error( "to be removed: blElementPreview");
            ...
            frame.on('load', function() {
                ...
                var fileAccessDate = new Date();
                head.append('<link rel="stylesheet" href="'+$scope.baseUrl+'/assets/css/iframe.css?'+fileAccessDate.getTime()+'">');
