(function($){
        ...
        function _init(sel, options){
                ...
                rotator.bind('mousedown.freetrans', _ifLeft(_noSelect(function(evt) {
                        ...
                        var degrees = 0;
                        var values = data.node.css('transform').split('(')[1];
                        if(values){
                        ...
                        var drag = _noSelect(function(evt) {
                                $('rotate-stage').removeClass('inactive')
                                ...
                                data.node.css('transform','rotate('+Math.round(data.angle)+'deg)');
                        ...
                        var up = function(evt) {
                                ...
                                $('rotate-stage').addClass('inactive')
                        };
        ...
        function _draw(sel, data) {
            ...
            data.rect = data.node[0].getBoundingClientRect();

            if (data.rect.width && data.rect.height) {
                data.selectBox.css({
                    top: data.rect.top,
                    left: data.rect.left - 7 + data.$rootScope_frameOffset_left - data.$rootScope_elemsContWidth,
