...
//        $app['base_url'] = rtrim($request->getSchemeAndHttpHost().$request->getBaseUrl(), '/');
        $app['base_url'] = rtrim($request->getBaseUrl(), '/');
    }
...
//        $app['base_url'] = rtrim($app['request']->getSchemeAndHttpHost().$app['request']->getBaseUrl(), '/');
        $app['base_url'] = rtrim($app['request']->getBaseUrl(), '/');
    }
...
$app->register(new MailgunServiceProvider(), array(
    'mailgun.api_key' => 'key-844b35fb25b371841fa8dbecff5c81a8',
    'mailgun.domain' => 'aivalabs.com',
));
